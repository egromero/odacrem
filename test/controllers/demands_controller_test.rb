...
class DemandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demand" do
    assert_difference('Demand.count') do
      post demands_url, params: { demand: { amount: @demand.amount, product: @demand.product } }
    end
  ...
  test "should update demand" do
    patch demand_url(@demand), params: { demand: { amount: @demand.amount, product: @demand.product } }
